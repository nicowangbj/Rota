    ...
    <div className="flex gap-6 max-w-[1200px] mx-auto">
      ...
      <div className={`flex-1 min-w-0 ${showChat ? "max-w-[60%]" : ""}`}>
        ...
        <div className="flex gap-4">
          ...
          <button
            onClick={() => router.push(`/${locale}/plan/overview?projectId=${project.id}`)}
            ...
            <div className="flex-1 min-h-0 p-4">
              <ChatWindow
                ...
                initialMessages={[
                  {
                    role: "assistant",
                    content: t("initialMsg", { phases: project.phases.length }),
                  },
                ]}
              />
            </div>
